...
import bgImage from '../../images/banner-pic.gif';
    ...
    return (
        <div className="home-section container-fluid">
            <div className="row m-0 p-0">
                ...
                <div className="col-md-6 home-second-div align-self-center">
                    <div className="p-5">
                        <h1 className="text-center pt-2">Welcome to <span className={`${textCrimson}`}>ZEN PC</span></h1>
